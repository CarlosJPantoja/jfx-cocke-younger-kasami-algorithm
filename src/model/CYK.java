...
public class CYK {
	...
	public boolean checkStringGeneration(String string) {
		...
		if (table[0][table[0].length - 1].contains(INITIAL_VARIABLE))
			return true;
		else
			return false;
	}
	...
	private String[][] buildTableCYK(String string) {
		String[][] table = new String[string.length()][];
		table[0] = new String[string.length()+1];
